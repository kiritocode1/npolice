		...
		<div className="container mx-auto px-4 py-8">
			<div className="max-w-6xl mx-auto">
				<div className="mb-8 text-center">
					<h1 className="text-3xl font-bold mb-4">Police Stations</h1>
					<p className="text-muted-foreground text-lg">Find police stations in Chhatrapati Sambhaji Nagar and get contact information, services, and directions.</p>
				</div>
							...
							<CardHeader>
								<div className="flex items-start justify-between">
									<div className="flex-1">
										...
										<CardDescription className="text-base mt-2">{station.address}</CardDescription>
									</div>
								...
								<div className="grid md:grid-cols-2 gap-6">
									<div className="space-y-3">
										...
										<div className="flex items-center gap-2">
											...
											<span>Officer: {station.officer}</span>
										</div>
									</div>
									<div>
				...
				<Card className="mt-8">
					...
					<CardContent>
						<div className="text-center space-y-4">
							<p className="text-lg">For immediate police assistance, call our emergency helpline</p>
							<Button
								size="lg"
