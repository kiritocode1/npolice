		...
		return (
			<section className="w-full px-4 pb-20 pt-20">
				<div className="mx-auto w-full max-w-6xl overflow-hidden rounded-3xl ring-1 ring-black/5">
					...
					{/* Cards row - Static Layout */}
					<div className="flex items-end justify-center gap-8 px-4 pb-8 md:px-6 h-[500px] w-full max-w-full">
						{/* Card 1: Latest News & Updates */}
						<div className="relative rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm flex-1 max-w-xs h-96 flex flex-col justify-between dark:bg-neutral-800 dark:border-neutral-700 overflow-hidden group cursor-pointer">
						...
						{/* Card 2: Portal */}
						<div className="relative rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm flex-1 max-w-xs h-80 flex flex-col justify-between dark:bg-neutral-800 dark:border-neutral-700 overflow-hidden group cursor-pointer">
							<div className="flex flex-col justify-between h-full">
								<div>
						...
						<div className="flex flex-col items-center justify-center flex-1 max-w-xs h-64">
							<Image
								src="/emblem.webp"
			...
			<div className="mx-auto w-full max-w-6xl overflow-hidden rounded-3xl  ring-1 ring-black/5">
				...
				<div className="flex items-end justify-center gap-8 px-4 pb-8 md:px-6 h-[500px] w-full max-w-full">
					...
					<motion.div
						...
						initial={isPerformanceMode ? {} : { opacity: 0, y: 50 }}
						animate={isPerformanceMode ? {} : { opacity: 1, y: 0 }}
						transition={isPerformanceMode ? { duration: 0 } : { duration: 0.5, delay: 0.1 }}
						whileHover={isPerformanceMode ? {} : { scale: 1.02, transition: { duration: 0.2 } }}
					>
					...
					<motion.div
						...
						initial={isPerformanceMode ? {} : { opacity: 0, y: 30 }}
						animate={isPerformanceMode ? {} : { opacity: 1, y: 0 }}
					...
					<motion.div
						...
						initial={isPerformanceMode ? {} : { opacity: 0, scale: 0.8 }}
						animate={isPerformanceMode ? {} : { opacity: 1, scale: 1 }}
						transition={isPerformanceMode ? { duration: 0 } : { duration: 0.6, delay: 0.3 }}
					>
						<Image
							src="/emblem.webp"
							alt="Indian National Emblem"
					...
					<motion.div
						...
						initial={isPerformanceMode ? {} : { opacity: 0, y: 30 }}
						animate={isPerformanceMode ? {} : { opacity: 1, y: 0 }}
						transition={isPerformanceMode ? { duration: 0 } : { duration: 0.5, delay: 0.4 }}
						whileHover={isPerformanceMode ? {} : { scale: 1.02, transition: { duration: 0.2 } }}
					>
						{/* Background image on hover */}
						<div
					...
					<motion.div
						...
						initial={isPerformanceMode ? {} : { opacity: 0, y: 50 }}
						animate={isPerformanceMode ? {} : { opacity: 1, y: 0 }}
						transition={isPerformanceMode ? { duration: 0 } : { duration: 0.5, delay: 0.5 }}
						whileHover={isPerformanceMode ? {} : { scale: 1.02, transition: { duration: 0.2 } }}
					>
						{/* Background image on hover */}
						<div
